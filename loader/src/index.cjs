...
const Module = (() => {
  ...
  return function (binaryOrInstantiate, _limit, _maxMemory) {
    var Module = Module || {};
    ...
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '_handle')) {
      Object.defineProperty(Module['ready'], '_handle', { configurable: true, get: function () { abort('You are getting _handle on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      Object.defineProperty(Module['ready'], '_handle', { configurable: true, set: function () { abort('You are setting _handle on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
    }
    ...
    var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 6291456; legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
